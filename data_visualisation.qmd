...
consisting of a few set of panels. The idea is for you to choose focused
...
1. Decide on question about the crabs data set. Examples: (i) demographics of
...
3. Use `{patchwork}` to make the figure.
4. Export it to PDF into the `plots/` folder.
5. Finally, send your PDF to the trainers for a final showcase amongst the
participants.
